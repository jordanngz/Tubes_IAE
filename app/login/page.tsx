...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="absolute bottom-20 right-10 w-40 h-40 bg-amber-200/30 rounded-full blur-3xl animate-float-delayed" />
      <div className="absolute top-1/2 left-1/3 w-24 h-24 bg-red-200/20 rounded-full blur-2xl animate-float-slow" />
        ...
        <div className="w-full max-w-md animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/50 p-8 md:p-10">
            ...
            <div className="text-center mb-8 animate-in fade-in slide-in-from-top-2 duration-500 delay-100">
              ...
              <p className="text-slate-600">Masuk ke akun Canned It Anda</p>
            </div>
            ...
            {/* Register Link */}
            <p className="text-center text-sm text-slate-600 mt-6 animate-in fade-in duration-500 delay-800">
              Belum punya akun?{" "}
